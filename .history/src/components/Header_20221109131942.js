  ...
  return (
    <header>
      ...
      <div className="flex bg-gray-700 h-14 items-center">
        ...
        rounded-sm hover:border-2 font-bold h-8 p-4"
        >
          <Bars3Icon className="h-8 mr-1" /> All
        </p>
        <p
          className="flex text-md text-white items-center cursor-pointer 
        rounded-sm hover:border-2 p-3 h-8 font-semibold"
        >
          Today's Deals
        </p>
        <p
        ...
        <p
          className="flex text-md text-white items-center cursor-pointer 
        rounded-sm hover:border-2 p-3 h-8"
        >
          Sell
        </p>
      </div>
