...
function Header() {
  return (
    <header>
      ...
      <div className="flex bg-gray-700 h-10">
        <p className="flex text-xl text-white items-center cursor-pointer hover:border font-bold p-2">
          <Bars3Icon className="h-8" /> All
        </p>
      </div>
    </header>
  );
