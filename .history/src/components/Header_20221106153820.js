  ...
  return (
    <header>
      <div className="flex flex-grow items-center p-1 py-2 bg-amazon_blue">
        ...
        <div
          className="text-white flex space-x-4 text-sm items-center 
        font-semibold cursor-pointer ml-4"
        >
          <div className="link">
            <p className="cursor-pointer">Hello Lakshitha</p>
            <p className="font-extrabold cursor-pointer">Account & Lists</p>
          </div>
          <div className="link">
            <p className="cursor-pointer">Returns</p>
            <p className="font-extrabold cursor-pointer">& Orders</p>
          </div>
          <div className="flex items-center link">
            <ShoppingCartIcon className="h-10 cursor-pointer" />
            <p className="font-extrabold cursor-pointer">Basket</p>
          </div>
        </div>
      </div>
    </header>
